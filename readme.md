...
> 这是 v2 版本，v1 版本已于 2025/1/15 停止更新，代码在 [v1-legacy](https://github.com/vikiboss/60s/tree/v1-legacy) 分支，建议尽快迁移至 v2 版本。

使用 [Deno](https://deno.com/) 构建的一系列高质量、开源、可靠、全球 CDN 加速的开放 API 集合，也支持 Cloudflare Workers、Bun 部署。
