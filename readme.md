...
> **高质量、开源、可靠、全球 CDN 加速** 的开放 API 集合，让你用最简单的方式获取最准确的数据。
...
| 🏞️ 必应壁纸 | `/v2/bing` | 每日精美壁纸 | Bing官方 |
| 📅 历史今天 | `/v2/today_in_history` | 历史上的今天 | 权威历史资料 |
| 🤖 AI 快讯 | `/v2/ai-news` | 每日AI行业资讯 | AI工具集 |
...
| API | 端点 | 描述 | 特色功能 |
|-----|------|------|----------|
| 🌍 在线翻译 | `/v2/fanyi` | 多语言翻译 | 支持109种语言 |
| 🌦️ 天气查询 | `/v2/weather` | 实时天气预报 | 全国城市覆盖 |
| 📡 IP 查询 | `/v2/ip` | IP地址定位 | 精确地理位置 |
| 🗓️ 农历转换 | `/v2/lunar` | 公历农历互转 | 天干地支/节气 |
| ❓ 百科查询 | `/v2/baike` | 百度百科词条 | 智能搜索 |
| 🎮 Epic 免费 | `/v2/epic` | Epic免费游戏 | 每周更新 |
| 🐦 OG 信息 | `/v2/og` | 网页元信息提取 | 社交分享优化 |
| 🌈 哈希工具 | `/v2/hash` | 多种编码解码 | MD5/Base64/URL等 |

### 🎓 学习编程类

| API | 端点 | 描述 | 内容数量 |
|-----|------|------|----------|
| 💻 **JS 趣味题** | `/v2/js-questions` | JavaScript 面试题库 | 149+ 精选题目 |
| 📊 题库统计 | `/v2/js-questions/stats` | 题库数据统计 | 实时统计信息 |
...
curl "https://60s.viki.moe/v2/weather?query=北京"
